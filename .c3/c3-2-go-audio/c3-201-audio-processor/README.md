...
```mermaid
flowchart TB
    subgraph c3201["c3-201: Audio Processor"]
...
| Depends On | Purpose |
|------------|---------|
| c3-202 Stream Extractor | Extract audio URLs |
| c3-203 Opus Encoder | Encode audio to Opus |
| c3-204 Jitter Buffer | Buffer output frames |
