...
```mermaid
flowchart TB
    subgraph c3108["c3-108: Jitter Buffer"]
...
| Depended By | Purpose |
|-------------|---------|
| c3-105 Audio Processor | Buffer before transmission |
| c3-107 Opus Encoder | Provides frames to buffer |
